...
STATE_STORE_DATA_MOVE_TRANSACTIONS= "DataMoveTransactions"
...
SERVICE_BUS_STUDY_CONTAINER_CREATE_QUEUE_NAME: str = config("SERVICE_BUS_STUDY_CONTAINER_CREATE_QUEUE_NAME", default="")
SERVICE_BUS_DATA_MOVE_QUEUE_NAME: str = config("SERVICE_BUS_DATA_MOVE_QUEUE_NAME", default="")
