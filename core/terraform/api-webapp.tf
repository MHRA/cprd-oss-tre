...
resource "azurerm_linux_web_app" "api" {
  ...
  app_settings = {
    ...
    "SERVICE_BUS_STUDY_CONTAINER_CREATE_QUEUE_NAME"  = local.study_folder_create_queue_name
    "SERVICE_BUS_DATA_MOVE_QUEUE_NAME"               = local.data_move_requests_queue_name
