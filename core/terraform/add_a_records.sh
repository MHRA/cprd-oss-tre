...
# Find IP of Synapse SQL Private Endpoint - privateIpAddress needs to be with a lowercase p in Ip
...
# Find IP of Synapse SQL Ondemand Private Endpoint - privateIpAddress needs to be with a lowercase p in Ip
# because of an older version of az-cli in Dockerfile of .devcontainer - AZURE_CLI_VERSION=2.37.0-1~bullseye
# In the latest version of az-cli IP needs to be uppercase like this privateIPAddress
...
# Find IP of Storage Account Private Endpoint for VM template scripts - privateIpAddress needs to be with a lowercase p in Ip
# because of an older version of az-cli in Dockerfile of .devcontainer - AZURE_CLI_VERSION=2.37.0-1~bullseye
# In the latest version of az-cli IP needs to be uppercase like this privateIPAddress
