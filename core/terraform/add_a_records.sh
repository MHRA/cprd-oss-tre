...
# Find IP of Synapse SQL Private Endpoint - privateIpAddress needs to be with a lowercase IP because of the older version of az-cli
...
# Find IP of Synapse SQL Ondemand Private Endpoint - privateIpAddress needs to be with a lowercase IP because of the older version of az-cli
